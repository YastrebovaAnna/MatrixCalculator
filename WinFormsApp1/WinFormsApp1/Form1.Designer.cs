namespace WinFormsApp1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            buttonSubMenuLu=new Button();
            bttnDiagonalView=new Button();
            bttn3view=new Button();
            ...
            buttonExitProg.Location=new Point(0, 892);
            ...
            buttonMin.Location=new Point(0, 823);
            ...
            buttonbackpagehome.Location=new Point(0, 738);
            ...
            panelForDeter.Location=new Point(0, 542);
            ...
            bttnDeter.Location=new Point(0, 456);
            ...
            panelTransformSubMenu.Controls.Add(buttonSubMenuLu);
            panelTransformSubMenu.Controls.Add(bttnDiagonalView);
            panelTransformSubMenu.Controls.Add(bttn3view);
            ...
            panelTransformSubMenu.Size=new Size(264, 197);
            panelTransformSubMenu.TabIndex=4;
            // 
            // buttonSubMenuLu
            // 
            buttonSubMenuLu.Dock=DockStyle.Top;
            buttonSubMenuLu.FlatAppearance.BorderSize=0;
            buttonSubMenuLu.FlatStyle=FlatStyle.Flat;
            buttonSubMenuLu.Font=new Font("Times New Roman", 12F, FontStyle.Regular, GraphicsUnit.Point);
            buttonSubMenuLu.ForeColor=Color.FromArgb(66, 73, 83);
            buttonSubMenuLu.Location=new Point(0, 155);
            buttonSubMenuLu.Margin=new Padding(3, 4, 3, 4);
            buttonSubMenuLu.Name="buttonSubMenuLu";
            buttonSubMenuLu.Padding=new Padding(30, 0, 0, 0);
            buttonSubMenuLu.Size=new Size(264, 38);
            buttonSubMenuLu.TabIndex=5;
            buttonSubMenuLu.Text="LU - розклад";
            buttonSubMenuLu.TextAlign=ContentAlignment.MiddleLeft;
            buttonSubMenuLu.UseVisualStyleBackColor=true;
            buttonSubMenuLu.Click+=buttonSubMenuLu_Click;
            // 
            // bttnDiagonalView
            // 
            bttnDiagonalView.Dock=DockStyle.Top;
            bttnDiagonalView.FlatAppearance.BorderSize=0;
            bttnDiagonalView.FlatStyle=FlatStyle.Flat;
            bttnDiagonalView.Font=new Font("Times New Roman", 12F, FontStyle.Regular, GraphicsUnit.Point);
            bttnDiagonalView.ForeColor=Color.FromArgb(66, 73, 83);
            bttnDiagonalView.Location=new Point(0, 117);
            bttnDiagonalView.Margin=new Padding(3, 4, 3, 4);
            bttnDiagonalView.Name="bttnDiagonalView";
            bttnDiagonalView.Padding=new Padding(30, 0, 0, 0);
            bttnDiagonalView.Size=new Size(264, 38);
            bttnDiagonalView.TabIndex=4;
            bttnDiagonalView.Text="Діагональний вигляд";
            bttnDiagonalView.TextAlign=ContentAlignment.MiddleLeft;
            bttnDiagonalView.UseVisualStyleBackColor=true;
            bttnDiagonalView.Click+=bttnDiagonalView_Click;
            // 
            // bttn3view
            // 
            bttn3view.Dock=DockStyle.Top;
            bttn3view.FlatAppearance.BorderSize=0;
            bttn3view.FlatStyle=FlatStyle.Flat;
            bttn3view.Font=new Font("Times New Roman", 12F, FontStyle.Regular, GraphicsUnit.Point);
            bttn3view.ForeColor=Color.FromArgb(66, 73, 83);
            bttn3view.Location=new Point(0, 78);
            bttn3view.Margin=new Padding(3, 4, 3, 4);
            bttn3view.Name="bttn3view";
            bttn3view.Padding=new Padding(30, 0, 0, 0);
            bttn3view.Size=new Size(264, 39);
            bttn3view.TabIndex=3;
            bttn3view.Text="Трикутний вигляд";
            bttn3view.TextAlign=ContentAlignment.MiddleLeft;
            bttn3view.UseVisualStyleBackColor=true;
            bttn3view.Click+=bttn3view_Click;
            // 
            // bttnInversion
            // 
            ...
            bttnInversion.Size=new Size(264, 39);
        ...
        private Button bttnDiagonalView;
        private Button bttn3view;
        ...
        private Button buttonSubMenuLu;
